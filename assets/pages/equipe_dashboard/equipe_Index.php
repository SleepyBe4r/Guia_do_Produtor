...
<body>
    ...
    <div class="main-content">
        ...
        <div class="card mt-4">
            <div class="card-header">Membros</div>
                <div class="card-body">                    
                    <?php require_once("../../php/equipe_controller/listar_Equipe.php") ?>
    ...
    <script>
            function remover_Equipe(ID) {     
                
                var resultado = confirm("Deseja REMOVER o integrante da equipe?");
                if (resultado == true) {  
                    $.ajax({
                        type: "GET",
                        data: { ID_Equipe: ID },
                        url: "../php/equipe_controller/remover_Equipe.php",
                        dataType: "json",
        ...
        function editar_Equipe(ID) {                                         
            location.href = `./equipe_Edit.php?id_equipe=${ID}`;           
        }
        </script>           
</body>
</html>
