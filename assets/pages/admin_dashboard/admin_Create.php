            ...
            <form action="../../php/equipe_controller/cadastrar_Equipe.php" method="POST" enctype="multipart/form-data" class="p-4 border rounded bg-light">
                <div class="form-group">
                    ...
                    <select class="form-control" name="tipo" id="slct_tipo" required>
                        <option value="" z disabled>Selecione o Tipo</option>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="login" id="txt_login" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nome" id="txt_nome" placeholder="Digite o nome completo" required>
                </div>
